...
<div className="grid lg:grid-cols-4 grid-cols-1 sm:grid-cols-2 place-items-center">
    {projects.slice(0,4).map((project,idx) => 
        <m.div key={project.id} variants={fadeIn('up','spring',idx*0.3,0.5)} initial="hidden"  whileInView="show" viewport={{once:false, amount:0.5}}  className="h-96 relative after:absolute after:inset-0 after:content-[''] group after:bg-gradient-to-b after:from-transparent  after:to-black/60 max-w-lg overflow-hidden cursor-pointer">
